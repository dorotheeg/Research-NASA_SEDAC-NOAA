# -*- coding: utf-8 -*-
"""
Created on Thu Oct 31 18:07:34 2019
...
path = r"\\DATASERVER1\GADdata$\dgrant\Documents\ArcGIS\Projects\TestingMyProject\Mexico\h08v06\2018"
env.workspace = path
...
# append the 0(s) in front to match the string file name
    ...
    # arcpy.management.Clip("DNB_Daily_Level3_h08v06.A2015001.5000.45_85_V25.tif", "-95.8304359304738 29.0088340374609 -94.9743937686575 29.9837291538774", r"\\DATASERVER1\GADdata$\dgrant\Documents\ArcGIS\Projects\TestingMyProject\Houston\PleaseWork.tif", "Houston_fishnet_poly", -9.990000e+02, "NONE", "NO_MAINTAIN_EXTENT")
        arcpy.management.Clip(file1, "-95.8304359306272 29.008834038133 -94.9743937682749 29.9837291544849", r"\\DATASERVER1\GADdata$\dgrant\Documents\ArcGIS\Projects\TestingMyProject\Houston\2018\Houston_2018_"+ counter + ".tif", r"\\DATASERVER1\GADdata$\dgrant\Documents\ArcGIS\Projects\TestingMyProject\Houston\Houston_fishnet_poly.shp", 0, "NONE", "NO_MAINTAIN_EXTENT")
        print (counter)
        count+=1
        temp = ""
